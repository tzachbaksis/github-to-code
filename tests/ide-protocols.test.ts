...
describe("IDE_CONFIGS", () => {
  it("vscode generates correct URL with line", () => {
    const url = IDE_CONFIGS.vscode.generateURL(
      "/home/user/project/file.ts",
      42,
    );
    expect(url).toBe(
      `vscode://file/${encodeURIComponent("/home/user/project/file.ts")}:42`,
    );
  });
  ...
  it("vscode generates correct URL without line", () => {
    ...
    expect(url).toBe(
      `vscode://file/${encodeURIComponent("/home/user/project/file.ts")}`,
    );
  });
  ...
  it("vscode encodes paths with spaces", () => {
    ...
    expect(url).toBe(
      `vscode://file/${encodeURIComponent("/home/user/my project/file.ts")}:1`,
    );
  });
